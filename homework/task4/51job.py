...
driver.find_element_by_css_selector('a.more').click_element()
...
driver.find_element_by_css_selector('.c.c_h>label').click_element()
...
driver.find_element_by_css_selector('#cottype_list span[title*="欧美"]').click_element()
...
driver.find_element_by_css_selector('#workyear_list span[data-value="02"]').click_element()

# 点击搜索
# ！！！ 注意有时候运行环境和调试环境不一样，需要多一些限制#

driver.find_element_by_css_selector(
'span.p_but[onclick^=kwdGoSearch]').click_element()
